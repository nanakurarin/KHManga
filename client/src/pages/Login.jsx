    ...
    <div className="max-w-md w-full mx-auto my-8">
      <div className="bg-slate-900/40 border border-slate-900 rounded-2xl p-8 space-y-6 shadow-xl shadow-slate-950/50">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400">Log in to sync your library bookmarks and reading history</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-center">
              ...
              <span className="text-[10px] text-rose-500 hover:underline cursor-pointer">Forgot Password?</span>
            </div>
            <input
              id="password"
              type="password"
        ...
        <div className="text-center text-xs text-slate-400">
          ...
          <Link to="/register" className="text-rose-500 hover:underline font-semibold">
            Register for free
          </Link>
        </div>
      </div>
